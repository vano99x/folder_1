...
public class PersonelPoint //extends EntityBase
{
	...
	private static void delete(int paramInt1, int paramInt2, Context paramContext)
	{
		DbConnector db = DbConnector.getInstance();
		String[] arrayOfString = new String[]{   String.valueOf(paramInt1),   String.valueOf(paramInt2)   };
