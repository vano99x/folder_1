...
public class HttpHelper
{
			   ...
			   java.lang.IndexOutOfBoundsException
	{
		...
		huc.setDoInput(true); huc.setDoOutput(false); huc.setUseCaches(false);
		//huc.setRequestMethod("GET"); huc.setReadTimeout(TIMEOUT);
		huc.setRequestProperty("Connection", "Keep-Alive"); huc.setRequestProperty("Content-Type", "text/json");
		//huc.connect();
